...
# Deploying Account
forge script script/DeployMyFactory.s.sol:DeployMyFactory \
...
# Deploying Account
forge script script/DeployMyAccount.s.sol:DeployMyAccount \
  --rpc-url https://0xrpc.io/sep \
  --broadcast \
  -- --vvvv

# Deploying NFT Contract
forge script script/DeployMyMFERS.s.sol:DeployMyMFERS \
  --rpc-url https://0xrpc.io/sep \
  --broadcast \
  -- --vvvv
